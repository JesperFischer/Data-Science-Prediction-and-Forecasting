...
```{r parameters visualization, fig.height=14, fig.width=16}
dd = get_experiment()
...
p1 = kalmanplot[[1]]+rwplot[[1]]+wbplot[[1]]+plot_layout(design = layout)+plot_annotation(tag_levels = list(c('B', 'C',"D","E","F","G")))
p2 = kalmanplot[[2]]+rwplot[[2]]+wbplot[[2]]+plot_layout(design = layout)+plot_annotation(tag_levels = list(c("E","F","G")))
