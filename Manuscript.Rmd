...
hier_pp <- do.call(rbind, lapply(rw_pp, "[[", 1))
...
sub_pp <- do.call(rbind, lapply(rw_pp, "[[", 2))
...
mod = cmdstan_model(here::here("Stan","myKalmanfilter_v2.stan"))
...
sum = rw_fit_ses1$summary(variables = c("alpha_1"))
...
sums2 = rw_fit_ses2$summary(variables = c("alpha_1"))
